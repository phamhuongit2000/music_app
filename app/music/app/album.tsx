...
import { getAlbumId, SERVER_DOMAIN } from '../config';
...
const AlbumDetailsScreen: React.FC<Props> = ({ route }) => {
    ...
    useEffect(() => {
        ...
        const fetchAlbumsData = async () => {
            try {
                const response = await fetch(`${SERVER_DOMAIN}/api/Album/GetById/${albumId}`);
  ...
  return (
    <View style={styles.container}>
        <Image source={{ uri: albumData?.imgUrl }} style={styles.albumImage} />
