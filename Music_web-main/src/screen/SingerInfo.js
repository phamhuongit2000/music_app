...
function SingerInfo() {
    ...
    useEffect(() => {
        fetch(`${config.serverDomain}/Singer/GetById/${singerChooseID}`)
        .then(res => res.json())
        .then(data =>{
            setSingerInfo(data);
            setSongs(data.listSongsInfo);
            console.log(data.listSongsInfo);
            console.log(data);
        })
    },[])
                        ...
                        <div className="singer-info-header">
                            <div className="singer-info-image-wrap">
                                <div className="singer-info-image"
                                    style={{backgroundImage: `url(${singerInfo?.avatarUrl || ""})`}}>
                                </div>
                            </div>
                            <div className="singer-info-introduce">
                                <div className="singer-name">{singerInfo?.name || ""}</div>
                                <div className="singer-text">{singerInfo?.description || ""}</div>
                            </div>
                        </div>
